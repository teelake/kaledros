...
# #This Python script is designed to run a web service using the Flask framework. 
# The service processes incoming HTTP POST requests, logs data to an Amazon S3 bucket, 
# and optionally sends messages to an Amazon SQS queue
# Explanation of the Updated Script
# Flask Web Application:

# The script now includes a Flask web application that listens for HTTP POST requests on the /process endpoint. This simulates a service that could be receiving traffic through your ALB.
# AWS Integration:

# The script logs incoming request data to an S3 bucket.
# Optionally, it sends a message to an SQS queue. This step is optional based on whether an SQS URL is provided in the environment variables.
# Environment Variables:

# AWS_REGION: The AWS region (e.g., us-west-2).
# S3_BUCKET_NAME: The name of the S3 bucket where logs will be stored.
# SQS_QUEUE_URL: The URL of the SQS queue (optional).