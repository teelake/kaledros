...
resource "aws_iam_role" "kaledros-eks-cluster-eks_node_group_role" {
...
resource "aws_iam_role_policy_attachment" "AmazonEKSWorkerNodePolicy" {
  ...
  role       = aws_iam_role.kaledros-eks-cluster-eks_node_group_role.name
}
...
resource "aws_eks_node_group" "eks_node_group" {
  ...
  node_role_arn   = aws_iam_role.kaledros-eks-cluster-eks_node_group_role.arn
  ...
  depends_on = [
    aws_eks_cluster.kaledros-eks-cluster
  ]
